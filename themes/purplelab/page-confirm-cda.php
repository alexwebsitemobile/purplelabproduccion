...
<?php echo do_shortcode('[contact-form-7 id="853" title="Accept terms and conditions"]'); ?>
                    </div>
                </div>
            </div>
        </div>
...
<script>
$('.wpcf7-acceptance').attr("disabled", true);
$('#cda').scroll(function() {
    if ($('#cda').scrollTop() > 800) {
        $('.wpcf7-acceptance').removeAttr("disabled");
    }
});
</script>
